...
const StudentLayout = () => {
  ...
  const sidebarLinks = [
    ...
    { path: '/student/download-notes', label: 'Download Notes', icon: Download },
    { path: '/student/downloaded-files', label: 'Downloaded Files', icon: FileDown },
  ]
    ...
    <div className="min-h-screen bg-secondary-50 flex">
      ...
      >
        ...
        <nav className="p-4 space-y-1">
          ...
          <Link
            to="/student/settings"
            className={`sidebar-link ${isActive('/student/settings') ? 'active' : ''}`}
          >
